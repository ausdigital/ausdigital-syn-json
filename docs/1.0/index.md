---
title: "AusDigital UBL JSON Syntax (SYN-JSON) 1.0 Specification"
specID: "ausdigital-syn-json/1"
 ...
 * exists to support the Digital Business Council [e-Invoicing initiative](https://ausdigital.github.io), and is under active development at [https://github.com/ausdigital/ausdigital-syn-json](https://github.com/ausdigital/ausdigital-syn-json).
...
development at
[https://github.com/ausdigital/ausdigital-syn](https://github.com/ausdigital/ausdigital-syn-json).
...
`Link: <https://raw.githubusercontent.com/ausdigital/ausdigital-bill/master/resources/ausdigital-syn-json/1.0/spec/Invoice.json>; rel="describedby"`
...
# UBL Syntax 1.0 Extended Codes Lists Specification
...
**[DBC context specific code lists repository](https://github.com/ausdigital/ausdigital-syn-json/tree/master/resources/1.0/codes/contexts)**
...
**[identifier scheme code lists repository](https://github.com/ausdigital/ausdigital-syn-json/tree/master/resources/1.0/codes/identifiers)** 
...
```
  "CodeList": {
    "ListURI": "https://github.com/ausdigital/ausdigital-code/tree/master/syn-json/resources/1.0/codes/identifiers/PartyIdentifiers-dbc.01.json",
 ...
 * There are several error conditions.  The error code and error message are described in the table below and MUST be inserted into the standard error structure defined in the The BILL specification.
...
The JSON instances MUST comply with the [UBL JSON Syntax 1.0 Specification](http://ausdigital.org/specs/ausdigital-syn-json/1.0/#json-syntax-for-ubl-documents).
The XML instances MUST comply with the [UBL XML Syntax 1.0 Specification](http://ausdigital.org/specs/ausdigital-syn-xml/1.0/#xml-syntax-for-ubl-documents).
...
## Sample UBL 2.1 XML compliant with UBL XML Syntax 1.0 Specification
...
## Sample UBL JSON file compliant with UBL JSON Syntax 1.0 Specification
